...
class TickerInfo():
    ...
    Attributes:
        client: A Client object that is created by api_key, api_secret=binance_secret.
    ...
    def get_base_asset(self, symbol):
        """Get base asset data in account .
...
class TradingMethod():
    ...
    Attributes:
        ...
        lookback:A int of the length of historical data (ex:1000).
