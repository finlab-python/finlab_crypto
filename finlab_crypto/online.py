...
class TickerInfo():
    ...
    def get_base_asset(self, symbol):
        ...
        Args:
          symbol:
            A str of trading symbol (ex: 'BTCUSDT').
    ...
    def get_asset_price_in_btc(self, asset):
        ...
        Returns:
            A float of price of the currency quoted by BTC.
        """
        if asset == 'BTC':
            return 1
...
class TradingPortfolio():
    ...
    def calculate_position_size(self, signals, rebalance_threshold=0.03, excluded_assets=list()):
        ...
        Args:
          ...
          excluded_assets:
            A list of asset name which are excluded during calculation.

        Returns:
          position:
            A dataframe of assets amount in the account.
          position_btc:
            A dataframe of assets amount in terms of BTC.
          transactions:
    ...
    def execute_orders(self, transactions, mode='TEST'):
        ...
        Args:
          ...
          mode:
            A str of transactions mode, we have 3 method.
              'TEST' is simulation.
